...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(820, 640, 75, 23))
        self.pushButton_3.setObjectName("pushButton_3")
        self.pushButton_3.clicked.connect(self.gray)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_3.setText(_translate("MainWindow", "灰階"))
    ...
    def gray(self):
        ...
        self.label.setPixmap(QtGui.QPixmap.fromImage(image_process.alter_to_Qimage_datatype(img)))
